...
RSpec.describe CommentsController, type: :controller do
  ...
  # #6 create specs for guest users, who we will redirect to sign in if they attempt to create or delete a comment
  context "guest" do
...
# #7 create specs for member users who attempt to create new comments or delete comments they don't own. We will allow member users to create new comments, but we'll redirect them to the posts show view if they try to delete another user's comment
  ...
  # #8 test that members users are able to create new comments and delete their own comments
  ...
  # #9 test that admin users are able to create and delete any comment, regardless of owner

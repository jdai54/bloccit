...
RSpec.describe UsersController, type: :controller do
  ...
  # #1 build a variable named factory_user using create(:user). A factory in programming is an object that creates other types of objects on demand. Our factory create User objects. Because we use create and not build, our objects is persisted to the database
  ...
  # #2 standard tests for testing the show action
    it "returns http success" do
